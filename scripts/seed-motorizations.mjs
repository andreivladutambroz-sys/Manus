 ...
 * Populates the database with official engine variants for common car brands
 */

import { drizzle } from 'drizzle-orm/mysql2';
import { vehicleMotorizations } from '../drizzle/schema.js';
import mysql from 'mysql2/promise';

const DATABASE_URL = process.env.DATABASE_URL || 'mysql://root:@localhost:3306/mechanic_helper';
