...
const MODELS_BY_BRAND: Record<string, string[]> = {
  ...
  "BMW": ["3 Series", "5 Series", "7 Series", "X1", "X3", "X5", "X7", "M3", "M5", "M4", "Z4", "i4", "iX", "i7", "i5", "M440i", "M440i xDrive", "330i", "340i", "530i", "540i", "750i", "760i", "X4", "X6", "M2", "M2 Competition", "M235i", "M235i xDrive", "1 Series", "2 Series", "4 Series", "6 Series", "8 Series", "i3", "i8"],
  ...
  "Toyota": ["Corolla", "Camry", "Highlander", "4Runner", "Sequoia", "Tundra", "Tacoma", "RAV4", "Venza", "Sienna", "Prius", "Mirai", "GR86", "Supra", "Land Cruiser", "Yaris", "Aygo", "Proace", "Hiace", "Hilux", "Fortuner", "Innova", "Rush", "Avanza", "Agya", "Wigo", "Glanza", "Rumion", "Veloz"],
  ...
  "Chevrolet": ["Silverado", "Equinox", "Traverse", "Tahoe", "Suburban", "Blazer", "Trailblazer", "Trax", "Bolt", "Malibu", "Cruze", "Sonic", "Spark", "Corvette", "Camaro", "Colorado", "Canyon", "Impala", "Volt", "Bolt EV", "Bolt EUV", "Equinox EV", "Blazer EV"],
  ...
  "Citroen": ["C3", "C4", "C5", "C6", "Berlingo", "Dispatch", "Jumper", "Ami", "C-Zero", "Saxo", "Xsara", "Picasso", "Jumpy", "Nemo"],
  ...
  "Porsche": ["911", "Boxster", "Cayman", "Cayenne", "Macan", "Panamera", "Taycan", "911 Carrera", "911 Turbo", "911 GT3", "911 GT2", "911 Targa"],
  "Lamborghini": ["Huracan", "Urus", "Revuelto", "Gallardo", "Murcielago", "Countach", "Diablo", "Aventador"],
  "Ferrari": ["F8 Tributo", "Roma", "Portofino", "SF90 Stradale", "F12 Berlinetta", "458 Italia", "430", "360", "Enzo", "LaFerrari"],
  "Maserati": ["MC20", "Grecale", "Levante", "Quattroporte", "Ghibli", "Alfieri", "Spyder", "GranTurismo"],
  "Bentley": ["Flying Spur", "Continental", "Continental GT", "Continental GTC", "Bentayga", "Mulsanne", "Brooklands", "Azure"],
  "Rolls-Royce": ["Phantom", "Phantom Drophead", "Ghost", "Wraith", "Dawn", "Cullinan", "Spectre"],
  "Aston Martin": ["DB11", "DB12", "Vantage", "DBS", "Rapide", "Vanquish", "DBX", "DBX707", "Valkyrie"],
  "Jaguar": ["F-PACE", "E-PACE", "I-PACE", "XF", "XE", "F-TYPE", "XJ", "C-X75"],
  ...
  "Alfa Romeo": ["Giulia", "Stelvio", "Tonale", "Giulietta", "Mito", "4C", "8C", "Spider", "Brera", "159"],
  "Fiat": ["500", "500X", "500e", "Panda", "Tipo", "Argo", "Mobi", "Strada", "Ducato", "Doblò", "Multipla", "Punto"],
  "Lancia": ["Ypsilon", "Thema", "Delta", "Lybra", "Kappa", "Y10", "Y", "Dedra"],
  "Suzuki": ["Swift", "Vitara", "Jimny", "Baleno", "Celerio", "Ignis", "Ertiga", "XL7", "S-Presso", "Alto", "Wagon R", "Dzire"],
  "Daihatsu": ["Mira", "Tanto", "Move", "Copen", "Terios", "Charade", "Hijet", "Atrai"],
  "Mitsubishi": ["Outlander", "Outlander PHEV", "Eclipse Cross", "ASX", "Mirage", "Attrage", "Xpander", "Pajero", "Pajero Sport", "Triton", "L200", "Lancer"],
  "Isuzu": ["D-Max", "MU-X", "Trooper", "Rodeo", "Pickup", "NPR", "NQR", "FVR"],
  "Tata": ["Nexon", "Nexon EV", "Harrier", "Safari", "Tiago", "Tigor", "Altroz", "Punch", "Hexa"],
  "Mahindra": ["XUV700", "XUV500", "XUV400", "Scorpio", "Bolero", "TUV300", "Marazzo", "Verito"],
  "BYD": ["Qin", "Song", "Yuan", "Tang", "Atto 3", "Atto 2", "Seagull", "Dolphin"],
  "NIO": ["ET5", "ET6", "ET7", "ET8", "ET9", "ES6", "ES8", "ES9"],
  "XPeng": ["G9", "P7", "P5", "G3", "X2", "X3", "X4", "X5"],
  "Li Auto": ["Mega", "Zhiyue", "Chuxiong", "Yangyang", "Lanyue"],
  "Geely": ["Emgrand", "Boyue", "Coolray", "Geometry", "Panda", "Tugella"],
  "Chery": ["Tiggo", "Arrizo", "QQ", "eQ", "Exeed", "Jetour"],
  "Great Wall": ["Haval", "Wey", "ORA", "Tank", "Poer", "Pao"],
  "GAC Aion": ["Aion S", "Aion V", "Aion Y", "Aion LX", "Aion Hyper"],
  "SAIC": ["MG ZS", "MG RX5", "MG RX8", "MG5", "MG6", "MG7"],
  "Changan": ["Uni-T", "Uni-K", "Uni-V", "Uni-Z", "Alsvin", "Eado"],
  "FAW": ["Besturn", "Oley", "Vita", "X40", "Senya"],
  "Dongfeng": ["Aeolus", "Venucia", "Forthing", "Fengon"],
  "Brilliance": ["V5", "V6", "V7", "H530", "H320"],
  "Lifan": ["Myway", "X50", "X60", "X70", "X80"],
  "Wuling": ["Hongguang", "Baojun", "Rongguang"],
  "Jac": ["iEV", "Refine", "Sunray", "Heyue"],
  "Zotye": ["T600", "Z300", "Z500", "Z700"],
  "Soueast": ["DX3", "DX5", "DX7", "V3", "V5"],
  "Luxgen": ["U5", "U6", "U7", "S3", "S5"],
  "Gogoro": ["Gogoro 3", "Gogoro 4", "Gogoro S"],
  "Kandi": ["EV", "K17", "K23", "K27"],
